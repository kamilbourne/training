...
using namespace std;
//list of functionsb
void fizzbuzz1(unsigned long long int n);
void fizzbuzz2(unsigned long long int n);
void fizzbuzz1assign(unsigned long long int n);
void fizzbuzz2assign(unsigned long long int n);
void fizzbuzz1print(unsigned long long int n);
void fizzbuzz2print(unsigned long long int n);
void fizzbuzz1clean(unsigned long long int n);
	...
	if(argc > 1 )
	{
		...
		for (int i = 1; i < argc; ++i)
		{
			...
			else
			{
				try
				{
					unsigned long long int temp_n = stoull(arg);
